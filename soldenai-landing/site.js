...
(function () {
  ...
  function renderSiteHeader() {
    return [
      ...
      '      <a href="/use-cases.html"' + currentAttr('/use-cases.html') + '>Use cases</a>',
      '      <a href="/manifesto.html"' + currentAttr('/manifesto.html') + '>Manifesto</a>',
      '    </nav>',
      '    <div class="ix-nav__actions">',
      '      <a class="ix-nav__signup" href="/contact.html"' + currentAttr('/contact.html') + '>Talk to us</a>',
      '    </div>',
      '  </div>',
      '</header>',
    ].join('');
  ...
  function renderSiteFooter() {
    return [
      ...
      '            <li><a href="/use-cases.html"' + currentAttr('/use-cases.html') + '>Use cases</a></li>',
      ...
      '          <ul>',
      '            <li><a href="/manifesto.html"' + currentAttr('/manifesto.html') + '>Manifesto</a></li>',
      '            <li><a href="/contact.html"' + currentAttr('/contact.html') + '>Contact</a></li>',
      '          </ul>',
      '        </div>',
      '        <div class="footer__col">',
