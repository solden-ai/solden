...
_REASON_LABELS = {
    ...
    "followup_attempt_limit_reached": "Solden reached the missing-context reminder limit.",
    "waiting_for_sla_window": "Solden is waiting for the next missing-context review window.",
    "gmail_auth_unavailable": "Gmail authorization is required before Solden can prepare the follow-up draft.",
    "draft_not_created": "Solden could not prepare the missing-context draft.",
