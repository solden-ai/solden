...
def build_passthrough_provenance(
    ...
    * :mod:`clearledgr.services.peppol_ubl_parser`
    * :mod:`clearledgr.integrations.erp_quickbooks_intake_adapter`
    * :mod:`clearledgr.integrations.erp_netsuite_intake_adapter` and ``_intake.py``
    * :mod:`clearledgr.integrations.erp_xero_intake_adapter`
    * :mod:`clearledgr.integrations.erp_sap_s4hana_intake_adapter` and ``_intake.py``
